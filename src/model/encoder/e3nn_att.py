...
from model.encoder.loc_resnet import ResnetPointnet, ResnetPointnet_4, ResnetBlockFC
from model.encoder.attention import Attention_Hac
...
class AttentionE3nn(torch.nn.Module):
